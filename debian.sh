...
function selectMirror(){
  ...
  MirrorBackup=(
    ["debian0"]="" 
    ["debian1"]="https://mirrors.huaweicloud.com/debian" 
    ["debian2"]="http://mirror.nju.edu.cn/debian" 
    ["debian3"]="http://deb.debian.org/debian" 
    ["debian4"]="http://mirrors.ocf.berkeley.edu/debian" 
    ["ubuntu0"]="" 
    ["ubuntu1"]="https://mirrors.aliyun.com/ubuntu"   # 添加阿里云镜像
    ["ubuntu2"]="http://ports.ubuntu.com"
    ["ubuntu3"]="http://archive.ubuntu.com/ubuntu"
    ["ubuntu4"]="https://mirrors.tuna.tsinghua.edu.cn/ubuntu"  # 添加清华镜像
    ["ubuntu5"]="https://mirrors.ustc.edu.cn/ubuntu"  # 添加中科大镜像
    ["centos0"]="" 
    ["centos1"]="http://vault.centos.org"
    ["centos2"]="http://mirror.centos.org/centos"
  ) 
  ...
  if [[ "$Relese" == 'Ubuntu' ]]; then
    ...
    [[ $? -eq '0' ]] && {
      ...
      [[ -n $isDigital ]] && {
        ...
        [[ "$isDigital" == '22.04' ]] && DIST='focal';
        [[ "$isDigital" == '24.04' ]] && DIST='focal';
        # [[ "$isDigital" == '26.04' ]] && DIST='jammy';
      }
    }
    LinuxMirror=$(selectMirror "$Relese" "$DIST" "$VER" "$tmpMirror")
  fi
